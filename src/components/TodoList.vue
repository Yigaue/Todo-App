<template>
 ...
 <input type="text" class="todo-input" placeholder="what need to be done" v-model = "newTodo" @keyup.enter="addTodo">
   ...
   <todo-item v-for="(todo, index) in todosFiltered" :key="todo.id" :todo="todo" 
   :index="index" :checkAll="!anyRemaining" @removedTodo="removeTodo" 
...
.todo-input{
    ...
    .todo-item-edit{
        ...
        font-family: 'Avenir', Helvitical, Arial, Sans-serif;
        &:focus {
            outline: none;
        }
    }
